...
public interface ProductGrpcMapper {
        @Mappings(value = {
                        ...
                        @Mapping(source = "variations", target = "variationsList", qualifiedByName = "mapListStringToProtoStringList")
        })
        CreateProductRequest toCreateProductRequest(CreateProductCommand product);
